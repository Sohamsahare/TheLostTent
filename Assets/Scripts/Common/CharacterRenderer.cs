...
namespace TheLostTent
{
    public class CharacterRenderer : MonoBehaviour
    {
        ...
        public PossibleDirection possibleDirections;
        ...
        public string CurrentDirection { get { return staticDirections[lastDirection]; } }
        int numDirections;
        private void Awake()
        {
        ...
        private void Start()
        {
            if (possibleDirections == PossibleDirection.Four)
            {
                numDirections = 4;
            }
            else
        ...
        public void SetDirection(Vector2 direction)
        {
            ...
            else
            {
                ...
                lastDirection = (
                                ...
                                DirectionToIndex(direction, numDirections);
            }
