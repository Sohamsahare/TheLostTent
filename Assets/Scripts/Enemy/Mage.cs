...
namespace TheLostTent
{
    public class Mage : Enemy
    {
        ...
        protected override IEnumerator Attack()
        {
            ...
            // TODO: Add pooler
            GameObject areaOfAttack = Instantiate(attackPrefab, GetAttackPosition(), Quaternion.identity);
            areaOfAttack.transform.localScale = Vector3.one * attackRadius;
            areaOfAttack.GetComponent<AreaOfAttack>().Initialise(damage, chargeTime, afterEffectTime);
            // render animations
            isoRenderer.animator.Play(attackAnimations[dir]);
            Destroy(areaOfAttack, 3f);
